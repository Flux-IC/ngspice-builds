...
[Schemline](https://github.com/Schemline-IC/schemline), compiled with **full BSIM4
...
See [Releases](https://github.com/Schemline-IC/ngspice-builds/releases) for
pre-built binaries. Schemline downloads these automatically via
...
3. Schemline's `ngspice_update.py` picks up the new release automatically
